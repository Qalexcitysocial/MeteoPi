...
<head>
    <meta charset="utf-8">
    <title>AutoGarden | Landing Page</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="home-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0s">
                            <h1>Welcome to your AutoGarden</h1>
                            <p>I am your <strong>Gardner Assistant</strong>. We find the problems, Create Solutions. Take care of your Garden is our Passion.</p>
                            <a class="button home" href="#portfolio">Get Started</a>
                        </div>
                    </div>
                    <!-- END HOME CONTENT -->
